                                    ...
                                    @forelse($myReports as $report)
                                        <div class="border-bottom p-3 hover-bg-light">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <span
                                                    class="badge bg-{{ $report->status === 'Validé final' ? 'success' : 'warning' }}">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <div class="fw-bold text-truncate">
                                                        {{ Str::limit($report->title, 30) }}</div>
                                                    <small class="text-muted">👨‍🎓
                                                        {{ $report->student->name ?? 'Étudiant' }}</small>
                                                </div>
                                                <span
                                                    class="badge bg-info">{{ $report->latestVersion->version ?? 'v1' }}</span>
                                            </div>
                                        </div>
                                    @empty
                                        <div class="text-center py-4 text-muted">
                        ...
                        <div class="col-md-6">
                            <div class="card border-0 shadow h-100 bg-gradient-warning bg-opacity-10">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <p class="text-muted mb-4">Consultez l'historique complet des versions et ajoutez
                                        vos commentaires</p>
                    ...
                    @if (auth()->user()->hasRole('student'))
                        <div class="col-md-6 col-lg-3">
                            <a href="{{ url('/student/dashboard') }}"
                                class="btn btn-outline-primary w-100 p-4 rounded-3 border-0 shadow-sm hover-shadow-lg">
                    ...
                    @if (auth()->user()->hasRole('teacher'))
                        <div class="col-md-6 col-lg-3">
                            <a href="{{ url('/teacher/reports') }}"
                                class="btn btn-outline-success w-100 p-4 rounded-3 border-0 shadow-sm hover-shadow-lg">
