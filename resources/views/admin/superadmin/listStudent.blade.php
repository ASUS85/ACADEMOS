                ...
                <form method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="search" class="form-control"
                               placeholder="Nom, matricule, email..." value="{{ request('search') }}">
                    </div>
                </form>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-inline-flex gap-2">
                                        <a href="{{ route('superadmin.students.edit', $student) }}"
                                           class="btn btn-light border btn-icon" title="Modifier">
                                            <i class="fas fa-pen text-success"></i>
                                        </a>

                                        <form action="{{ route('superadmin.users.destroy', $student) }}"
                                              method="POST" class="d-inline"
                                              onsubmit="return confirm('Supprimer {{ $student->name }} ?')">
                                            @csrf
                                            @method('DELETE')
