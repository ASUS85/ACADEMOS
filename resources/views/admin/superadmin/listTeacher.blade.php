    ...
    <div class="bg-light py-3 px-3 px-md-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('admin.teachers.create') }}" class="btn btn-success d-flex align-items-center gap-2 rounded-pill">
                ...
                <form method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="search" class="form-control"
                               placeholder="Nom, email, matricule..." value="{{ request('search') }}">
                    </div>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('superadmin.teachers.index') }}" class="btn btn-outline-secondary">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <form action="{{ route('superadmin.users.destroy', $teacher) }}"
