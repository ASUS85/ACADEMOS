    ...
    <div class="bg-light py-3 px-3 px-md-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('superadmin.admins.create') }}" class="btn btn-success d-flex align-items-center gap-2 rounded-pill">
                    ...
                    <tbody>
                        @forelse($admins as $admin)
                            <tr>
                                <td class="ps-4">
                                    <div class="d-flex align-items-center">
                                        <img src="https://ui-avatars.com/api/?name={{ urlencode($admin->name) }}&background=6366F1&color=fff&size=40&rounded=true"
                                ...
                                <td class="text-center">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <form action="{{ route('superadmin.admins.destroy', $admin) }}"
                                              ...
                                              onsubmit="return confirm('Supprimer {{ $admin->name }} ?')">
                                            @csrf
                                            @method('DELETE')
