<x-app-layout>
    <style>
        ...
        .chip-role-superadmin { background:#fee2e2; color:#dc2626; }
        .chip-role-admin { background:#fef3c7; color:#d97706; }
        .chip-role-teacher { background:#dbeafe; color:#1d4ed8; }
        .chip-role-student { background:#dcfce7; color:#15803d; }
        .chip-role-jury { background:#f3e8ff; color:#7c3aed; }
        .btn-icon {
            width: 32px;
            height: 32px;
            border-radius: 999px;
                                    ...
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        @if($user->hasRole('admin'))
                                            <a href="{{ route('superadmin.admins.edit', $user) }}"
                                               class="btn btn-light border btn-icon" title="Modifier Admin">
                                                <i class="fas fa-pen text-warning"></i>
                                            </a>
                                        @elseif($user->hasRole('teacher'))
                                            <a href="{{ route('superadmin.teachers.edit', $user) }}"
                                               class="btn btn-light border btn-icon" title="Modifier Enseignant">
                                                <i class="fas fa-pen text-primary"></i>
                                            </a>
                                        @elseif($user->hasRole('student'))
                                            <a href="{{ route('superadmin.students.edit', $user) }}"
                                               class="btn btn-light border btn-icon" title="Modifier Étudiant">
