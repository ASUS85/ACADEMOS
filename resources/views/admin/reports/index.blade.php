                        ...
                        <table class="table table-hover mb-0">
                            <thead class="table-light sticky-top">
                                <tr>
                                    ...
                                    <th class="border-0 py-3 text-center"><i class="fas fa-user-tie me-1"></i>Affecter
                                        Enseignant</th>
                                ...
                                @foreach ($reports as $report)
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge bg-secondary text-white">⏳ En attente
                                                    enseignant</span>
                                            @endif
                                        </td>
                                                ...
                                                <form method="POST"
                                                    ...
                                                    <div class="input-group input-group-sm mb-2">
                                                        <select name="teacher_id" class="form-select form-select-sm"
                                                            required>
                                                            @if (\App\Models\User::role('teacher')->count() === 0)
                                                                <option value="">Aucun enseignant disponible
                                                                </option>
                                                            @else
                                        ...
                                        <td class="text-center">
                                            @if ($report->teacher_status === 'Validé par enseignant' && !$report->jury_id)
                                                <form method="POST"
                                                    ...
                                                    @csrf
                                                    <div class="input-group input-group-sm mb-2">
                                                        <select name="jury_id" class="form-select form-select-sm"
                                                            required>
