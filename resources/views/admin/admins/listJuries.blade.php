<x-app-layout>
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div class="d-flex align-items-center">
                        <div class="bg-gradient-to-br from-purple to-blue-main text-white rounded-3 p-3 shadow-lg me-4"
        ...
        {{-- ALERT --}}
        @if (session('success'))
            <div class="alert alert-success border-0 shadow-lg rounded-3 mb-4 animate__animated animate__fadeIn"
                role="alert">
                <div class="d-flex align-items-center">
            ...
            <div class="text-center py-12">
                <div class="card shadow-xl mx-auto" style="max-width: 500px;">
                    <div class="card-body py-8">
                        <div class="bg-gradient-to-br from-gray-100 to-gray-200 rounded-full p-6 mx-auto mb-4 shadow-lg d-inline-flex"
                    ...
                    <table class="table-jury table mb-0">
                        ...
                        <tbody>
                            @foreach ($juries as $index => $jury)
                                ...
                                @endphp
                                <tr class="jury-row" data-jury-id="{{ $jury->id }}" data-bs-toggle="modal"
                                    data-bs-target="#juryDetail{{ $jury->id }}">
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-circle d-flex align-items-center justify-content-center me-3 shadow-sm"
                                                style="width: 45px; height: 45px; font-weight: 700; font-size: 0.85rem;">
                                                {{ substr($jury->report->student->name, 0, 2) }}
                                            </div>
                                            <div>
                                                <div class="fw-bold">{{ $jury->report->student->name }}</div>
                                                <small
                                                    class="text-muted">{{ Str::limit($jury->report->title, 40) }}</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span
                                            class="badge bg-success bg-opacity-20 text-success px-3 py-2 fw-semibold border border-success-subtle">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <button class="btn btn-outline-primary btn-sm jury-edit"
                                                data-bs-toggle="modal" data-bs-target="#editJury{{ $jury->id }}"
                                                title="Modifier">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <a href="{{ route('admin.reports.index') }}#report-{{ $jury->report->id }}"
                                                class="btn btn-outline-info btn-sm" title="Voir rapport">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <form method="POST" action="{{ route('admin.juries.destroy', $jury) }}"
                                                class="d-inline">
                                                @csrf @method('DELETE')
                                                <button type="submit" class="btn btn-outline-danger btn-sm"
                                                    onclick="return confirm('Supprimer ce jury ?')" title="Supprimer">
                                ...
                                {{-- MODAL DÉTAIL CARD --}}
                                <div class="modal fade" id="juryDetail{{ $jury->id }}" tabindex="-1"
                                    ...
                                    <div
                                        ...
                                        <div class="modal-content modal-card-preview">
                                            <div
                                                class="modal-header bg-gradient-to-r from-purple-gradient to-purple-600 text-white border-0 rounded-top-4 p-4">
                                            ...
                                            <div class="modal-body p-5">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mb-4">
                                                        <h6 class="fw-bold mb-3 text-uppercase text-muted"><i
                                                                class="fas fa-info-circle me-2"></i>Infos Rapport</h6>
                                                        <div class="d-flex align-items-center text-muted small mb-3">
                                                            <i
                                                                class="fas fa-graduation-cap text-primary me-2 fs-5"></i>
                                                            <span
                                                                class="fw-semibold">{{ $jury->report->student->filiere->name ?? 'Non spécifié' }}</span>
                                                            <span class="mx-3">•</span>
                                                            <span
                                                                class="fw-semibold">{{ $jury->report->student->level ?? 'N/A' }}</span>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 mb-4">
                                                        <h6 class="fw-bold mb-3 text-uppercase text-muted"><i
                                                                class="fas fa-users me-2"></i>Composition</h6>
                                                ...
                                                <div class="row g-3 mb-5">
                                                    @if ($president)
                                                        <div class="col-md-6 col-lg-3">
                                                            <div
                                                                class="text-center p-4 bg-gradient-to-br from-warning to-orange-500 text-white rounded-4 shadow-lg hover:scale-105 transition-all">
                                                                <div class="bg-white bg-opacity-20 p-3 rounded-circle mx-auto mb-3 d-inline-flex"
                                                                    style="width: 70px; height: 70px;">
                                                    ...
                                                    @if ($encadreur)
                                                        <div class="col-md-6 col-lg-3">
                                                            <div
                                                                class="text-center p-4 bg-gradient-to-br from-emerald-500 to-teal-500 text-white rounded-4 shadow-lg hover:scale-105 transition-all">
                                                                <div class="bg-white bg-opacity-20 p-3 rounded-circle mx-auto mb-3 d-inline-flex"
                                                                    style="width: 70px; height: 70px;">
                                                    ...
                                                    @if ($rapporteur)
                                                        <div class="col-md-6 col-lg-3">
                                                            <div
                                                                class="text-center p-4 bg-gradient-to-br from-blue-500 to-indigo-500 text-white rounded-4 shadow-lg hover:scale-105 transition-all">
                                                                <div class="bg-white bg-opacity-20 p-3 rounded-circle mx-auto mb-3 d-inline-flex"
                                                                    style="width: 70px; height: 70px;">
                                                    ...
                                                    @if ($autres->isNotEmpty())
                                                        @foreach ($autres->take(2) as $membre)
                                                            <div class="col-md-6 col-lg-3">
                                                                <div
                                                                    class="text-center p-4 bg-gradient-to-br from-slate-500 to-gray-600 text-white rounded-4 shadow-lg hover:scale-105 transition-all">
                                                                    <div class="bg-white bg-opacity-20 p-3 rounded-circle mx-auto mb-3 d-inline-flex"
                                                                        style="width: 70px; height: 70px;">
                                            ...
                                            <div class="modal-footer bg-light border-0 rounded-bottom-4 px-5 py-4">
                                                ...
                                                <div class="ms-auto">
                                                    <button class="btn btn-warning px-4 me-2 jury-edit"
                                ...
                                <div class="modal fade" id="editJury{{ $jury->id }}" tabindex="-1">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content rounded-4 shadow-xl">
                                            <div
                                                class="modal-header bg-gradient-to-r from-warning to-orange-500 text-white border-0 rounded-top-4">
                                                ...
                                                <div class="modal-body p-4">
                                                    <div id="members-container-{{ $jury->id }}">
                                                        @foreach ($jury->members as $member)
                                                            <div
                                                                class="member-row row align-items-end g-2 mb-3 p-3 border rounded-3">
                                                                <div class="col-md-5">
                                                                    <label
                                                                        class="form-label fw-semibold small mb-1">Membre</label>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <label
                                                                        class="form-label fw-semibold small mb-1">Rôle</label>
                                                                    <select name="members[][role]" class="form-select"
                                                                        required>
                                                                        <option value="president"
                                                                            {{ $member->pivot->role == 'president' ? 'selected' : '' }}>
                                                                            👑 Président</option>
                                                                        <option value="encadreur"
                                                                            {{ $member->pivot->role == 'encadreur' ? 'selected' : '' }}>
                                                                            👨‍🏫 Encadreur</option>
                                                                        <option value="rapporteur"
                                                                            {{ $member->pivot->role == 'rapporteur' ? 'selected' : '' }}>
                                                                            📋 Rapporteur</option>
                                                                        <option value="membre"
                                                                            {{ $member->pivot->role == 'membre' ? 'selected' : '' }}>
                                                                            👤 Membre</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <button type="button"
                                                                        class="btn btn-outline-danger w-100 remove-member h-100"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Gestion hover ligne tableau
            document.querySelectorAll('.jury-row').forEach(row => {
            ...
            document.querySelectorAll('.jury-edit').forEach(btn => {
                btn.addEventListener('click', function(e) {
                    e.stopPropagation();
                    const targetModal = this.getAttribute('data-bs-target');
                    const detailModal = bootstrap.Modal.getInstance(document.querySelector(
                        '.modal.show'));
                    if (detailModal) detailModal.hide();
                });
            });

            // Gestion backdrops multiples
            document.querySelectorAll('.modal').forEach((modal, index) => {
                modal.addEventListener('show.bs.modal', function() {
                    const backdrops = document.querySelectorAll('.modal-backdrop');
                    backdrops.forEach((backdrop, bIndex) => {
                        backdrop.style.zIndex = 1040 + (index + bIndex) * 10;
                    });
                    this.style.zIndex = 1050 + index * 10;
                });
            });
        });
